...
def _show_settings_help() -> None:
    showText(
        ...
        "target expected multiplier, and the reel face counts for each symbol.\n\n"
        "The current review stake is fixed at $1. Again loses $1, Hard gives $1 "
        "with no spin, Good spins for $1 x multiplier, and Easy spins for $2 x "
        "multiplier. Pair and triple multipliers are derived automatically from "
        "the EV target and slot faces."
    )
